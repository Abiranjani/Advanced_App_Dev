...
function Register() {
  return (
    <div class="relative flex flex-col bg-transparent shadow-none rounded-xl bg-clip-border items-center">
    ...
    <form class="max-w-screen-lg mt-8 mb-2 w-3/4 ">
      <div class="flex flex-col gap-6 mb-1">
        ...
        <div class="relative h-11 w-full min-w-[200px]">
          <input placeholder="abcd" required
        ...
        <div class="relative h-11 w-full min-w-[200px]">
          <input type="password" placeholder="****" required minLength={8} maxLength={15}
